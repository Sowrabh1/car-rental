	...
	<footer>
		<div class="wrapper footer">
			<ul>
				...
				<li class="about">
					<p>Sonko Rescue team is an organized company that rents cars and other vehicles to clients at lower costs. We we are here to serve every Citizen</p>
					<ul>
		...
		<div class="copyrights wrapper">
			Copyright &copy; <?php echo date("Y")?> All Rights Reserved | Designed by  Sowrabh & Team.
		</div>
	</footer><!--  end footer  -->
